 ...
 */
 ...
 [_QW] = LAYOUT( /* QWERTY */
   ...
   KC_CAPS, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_ENT , KC_NO  , KC_P4  , KC_P5  , KC_P6  , KC_EQL,
   KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT, KC_NO  , KC_UP  , KC_P1  , KC_P2  , KC_P3  , KC_PENT,
   KC_LCTL, KC_LGUI, KC_LALT, KC_NO  , KC_NO  , KC_SPC , KC_NO  , KC_NO  , KC_NO  , KC_RALT, KC_RCTL, KC_NO  , KC_LEFT, KC_DOWN, KC_RGHT, KC_P0  , KC_PDOT, KC_NO
  ),
